<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"  import="main.java.com.zawodny.domain.Scena"%>
...
<body>
	<jsp:useBean id="scena" class="main.java.com.zawodny.domain.Scena" scope="session" />
	<jsp:setProperty name="scena" property="*" />
	<jsp:useBean id="scenamanager" class="main.java.com.zawodny.service.ScenaManager"
		scope="application" />
