<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"  import="main.java.com.zawodny.domain.Przedstawienie"%>
...
<body>
	<jsp:useBean id="przedstawienie" class="main.java.com.zawodny.domain.Przedstawienie" scope="session" />
	<jsp:setProperty name="przedstawienie" property="*" />
	<jsp:useBean id="przedstawieniemanager" class="main.java.com.zawodny.service.PrzedstawienieManager"
		scope="application" />
